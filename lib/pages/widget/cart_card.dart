        ...
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(12),
                  image: DecorationImage(image: AssetImage('assets/image_shoes.png'))
                ),
              ),
              SizedBox(width: 12),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2),
                    Text('\$143,98', style: priceTexStyle.copyWith(
                      fontSize: 14,
                      fontWeight: regular
                    ))
                  ],
          ...
          Row(
            children: [
              ...
              SizedBox(width: 4,),
              Text('Remove', style: removeTextStyle.copyWith(fontSize: 12, fontWeight: light))
            ],
          )
        ],
      ),
